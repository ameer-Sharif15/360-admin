...
export default function MinimartPage() {
  ...
  const [form, setForm] = useState<Partial<MinimartItem>>({
    available: true,
    price: 0,
    stock: 0,
    image: "",
        ...
        {items.map((item) => (
          <div key={item.$id} style={cardStyle}>
            ...
            >
              ...
              <span style={{ fontWeight: 700, fontSize: 18, color: "#ff7f50" }}>
